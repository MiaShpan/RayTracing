...
public class Scenes {
	public static Scene scene1() {
		...
		return new Scene().initAmbient(new Vec(0.0))
				...
				.initRenderRefractions(true).initRenderReflections(true).initMaxRecursionLevel(3);
	}
	...
	public static Scene scene3() {
		...
		return new Scene().initAmbient(new Vec(1.0))
				...
				.initName("scene3").initAntiAliasingFactor(1).initRenderRefractions(true).initRenderReflections(true)
	...
	public static Scene scene4() {
		...
		pyramidScence.initRenderRefractions(true).initRenderReflections(true).initMaxRecursionLevel(6);
	...
	public static Scene scene5() {
		...
		return new Scene().initAmbient(new Vec(1.0))
				...
				.initRenderRefractions(true).initRenderReflections(true).initMaxRecursionLevel(6);
	}
